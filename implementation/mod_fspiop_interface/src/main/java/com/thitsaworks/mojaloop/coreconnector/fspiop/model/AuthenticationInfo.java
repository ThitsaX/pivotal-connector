...
import com.thitsaworks.mojaloop.coreconnector.fspiop.model.AuthenticationValue;
...
public class AuthenticationInfo {
  ...
  public AuthenticationInfo authentication(@javax.annotation.Nonnull AuthenticationType authentication) {
  ...
  public void setAuthentication(@javax.annotation.Nonnull AuthenticationType authentication) {
    this.authentication = authentication;
  }


  public AuthenticationInfo authenticationValue(@javax.annotation.Nonnull AuthenticationValue authenticationValue) {
  ...
  public void setAuthenticationValue(@javax.annotation.Nonnull AuthenticationValue authenticationValue) {
    this.authenticationValue = authenticationValue;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("authentication", "authenticationValue"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("authentication", "authenticationValue"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthenticationInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthenticationInfo is not found in the empty JSON string", AuthenticationInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthenticationInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthenticationInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthenticationInfo.openapiRequiredFields) {
      ...
      AuthenticationType.validateJsonElement(jsonObj.get("authentication"));
      // validate the required field `authenticationValue`
      AuthenticationValue.validateJsonElement(jsonObj.get("authenticationValue"));
  }
