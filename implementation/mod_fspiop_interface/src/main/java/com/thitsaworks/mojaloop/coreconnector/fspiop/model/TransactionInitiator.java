 ...
 */
@JsonAdapter(TransactionInitiator.Adapter.class)
public enum TransactionInitiator {
  ...
  public static class Adapter extends TypeAdapter<TransactionInitiator> {
    @Override
    public void write(final JsonWriter jsonWriter, final TransactionInitiator enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TransactionInitiator read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TransactionInitiator.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TransactionInitiator.fromValue(value);
  }
}
