 ...
 */
@JsonAdapter(AuthorizationResponse.Adapter.class)
public enum AuthorizationResponse {
  ...
  public static class Adapter extends TypeAdapter<AuthorizationResponse> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuthorizationResponse enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AuthorizationResponse read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AuthorizationResponse.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AuthorizationResponse.fromValue(value);
  }
}
