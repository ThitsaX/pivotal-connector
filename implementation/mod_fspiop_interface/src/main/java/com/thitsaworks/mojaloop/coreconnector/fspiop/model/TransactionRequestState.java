 ...
 */
@JsonAdapter(TransactionRequestState.Adapter.class)
public enum TransactionRequestState {
  ...
  public static class Adapter extends TypeAdapter<TransactionRequestState> {
    @Override
    public void write(final JsonWriter jsonWriter, final TransactionRequestState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TransactionRequestState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TransactionRequestState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TransactionRequestState.fromValue(value);
  }
}
